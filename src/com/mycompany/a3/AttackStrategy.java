...
public class AttackStrategy implements IStrategy {
	...
	public AttackStrategy(NPC input) {
		this.n = input;		
	}
	
	@Override
	public void apply(Point playerLoc) {
		...
		float a = playerLoc.getX() - nLoc.getX();
		float b = playerLoc.getY() - nLoc.getY();
...
//		System.out.println("desired heading: " + desiredHead);
		...
		System.out.println("NPC  #" + n.getSequenceNumber() + " is chasing player located at (" 
